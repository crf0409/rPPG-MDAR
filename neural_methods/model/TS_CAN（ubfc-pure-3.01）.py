...
#         #
#         out[:, 1:, 2 * fold_1_6:2 * fold_1_6+fold_1_12] = x[:, :-1,  2 * fold_1_6:2 * fold_1_6+fold_1_12]
#         #
#         out[:, :-1,  2 * fold_1_6+fold_1_12: 2 * fold_1_6+2*fold_1_12 ] = x[:, 1: , 2 * fold_1_6+fold_1_12: 2 * fold_1_6+2*fold_1_12 ]
#         #
#         out[:, :, 2 * fold_1_6+2*fold_1_12:] = x[:, :,2 * fold_1_6+2*fold_1_12:]
#         return out.view(nt, c, h, w)
...
class TSCAN(nn.Module):
    ...
    def __init__(self, in_channels=3, nb_filters1=32, nb_filters2=64, kernel_size=3, dropout_rate1=0.25,
        ...
        self.apperance_att_conv3 = nn.Conv2d(
            self.nb_filters1, 1, kernel_size=1, padding=(0, 0), bias=True)
        self.attn_mask_3 = Attention_mask()
        # Avg pooling
