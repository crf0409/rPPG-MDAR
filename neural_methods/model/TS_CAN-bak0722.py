...
#         raw_input = inputs[:, 3:, :, :]
#
#         d1 = self.TSM_1(diff_input)
#         d1 = torch.tanh(self.motion_conv1(d1))
#         d1 = self.simam1(d1)  # Apply SimAM
#
#         d2 = self.TSM_2(d1)
#         d2 = torch.tanh(self.motion_conv2(d2))
#
#         r1 = torch.tanh(self.apperance_conv1(raw_input))
#         r2 = torch.tanh(self.apperance_conv2(r1))
#
...
#         d4 = self.TSM_3(d4)
#         d5 = torch.tanh(self.motion_conv3(d4))
#         d5 = self.simam2(d5)  # Apply SimAM
#
#         d6 = self.TSM_4(d5)
#         d6 = torch.tanh(self.motion_conv4(d6))
#
#         r5 = torch.tanh(self.apperance_conv3(r4))
#         r6 = torch.tanh(self.apperance_conv4(r5))
#
