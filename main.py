...
'''
python main.py --config_file /home/siton01/rPPG-Toolbox-main/configs/train_configs/PURE_PURE_UBFC-rPPG_iBVPNet_BASIC.yaml
'''
...
def add_args(parser):
    ...
    parser.add_argument('--config_file', required=False,
                        default="/home/siton01/桌面/rPPG-Toolbox-main/configs/train_configs/PURE_PURE_UBFC-rPPG_PHYSNET_BASIC.yaml", type=str, help="The name of the model.")
